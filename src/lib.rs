...
mod tests {
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("H4JnrZA1sWvLkETRwtNmt57Zjcyac74UASSes81qmxAL").unwrap();
        ...
        // Calculate exact fee rate to transfer entire SOL amount of account minus fees
        let fee = rpc_client
    ...
    fn complete() {
        ...
        // Create a PDA for "prereq" text with u8 array
